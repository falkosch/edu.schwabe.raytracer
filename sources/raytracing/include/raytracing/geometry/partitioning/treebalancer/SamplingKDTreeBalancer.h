...
namespace raytracer {
  ...
  protected:
    ...
    sampleSplittingPlane(const ASizeT axis, const AxisAlignedBoundingBox &bounding, const Float4 &sample);

    static const KDTreePlane
    sampleSplittingPlane(const ASizeT axis, const Float4 &offset, const Float4 &normalization, const Float4 &sample);

    static const KDTreePlane
    sampleSplittingPlane(const ASizeT axis, const Float offset, const Float normalization, const Float sample);
