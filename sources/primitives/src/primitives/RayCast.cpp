...
namespace primitives
{
  ...
  RayCast
  toObjectSpace(const RayCast& rayCast, const MFloat4x4& transInvModelMatrix, const Float4& objectSpaceOrigin) noexcept
  {
    return RayCast(
  ...
  RayCast toObjectSpace(const RayCast& rayCast, const MFloat4x4& inverseModelMatrix) noexcept
  {
