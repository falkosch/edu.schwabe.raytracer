...
namespace raytracerui {
  void DragonScene::setup(Scene &scene, Resources &resources) {
    ...
    sceneObject->setShininessShader(std::make_unique<Resources::ConstMaterialShader>(Float4(0.f, 0.f, 0.f, 0.f)));
    ...
    sceneObject->translateTexture(Float2(0.f, 0.f));
    sceneObject->setEmittanceShader(std::make_unique<Resources::ConstMaterialShader>(Float4(0.f, 0.f, 0.f, 0.f)));
    sceneObject->setDiffusionShader(std::make_unique<Resources::ConstMaterialShader>(Float4(0.f, 0.f, 0.f, 0.f)));
    sceneObject->setReflectanceShader(std::make_unique<Resources::ConstMaterialShader>(Float4(1.f, 1.f, 1.f, 0.13f)));
    sceneObject->setSpecularShader(std::make_unique<Resources::ConstMaterialShader>(Float4(0.f, 0.f, 0.f, 0.f)));
    sceneObject->setShininessShader(std::make_unique<Resources::ConstMaterialShader>(Float4(0.f, 0.f, 0.f, 0.f)));
    sceneObject->setTransmittanceShader(std::make_unique<HDRImageShader>(*resources.getPPM("marble")));
    sceneObject->setRefractionEtaShader(std::make_unique<Resources::ConstMaterialShader>(
