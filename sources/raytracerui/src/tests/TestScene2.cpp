...
namespace raytracerui {
  void TestScene2::setup(Scene &scene, Resources &resources) {
    ...
    sceneObject->setSpecularShader(new Resources::ConstMaterialShader(Float4(1.f, 1.f, 1.f, 0.5f)));
    ...
    sceneObject->rotateTexture(0.f);
    sceneObject->translateTexture(Float2(0.f, 0.f));
    sceneObject->setEmittanceShader(new Resources::ConstMaterialShader(Float4(.9f, .95f, 1.f, .1f)));
    ...
    sceneObject->setSpecularShader(new Resources::ConstMaterialShader(Float4(1.f, 1.f, 1.f, .9f)));
    sceneObject->setShininessShader(new Resources::ConstMaterialShader(Float4(1.f, 1.f, 1.f, 32.f)));
