...
namespace vectorization {
  struct v_i32_8 {
    ...
    v_i32_8() noexcept;
    v_i32_8(const PackedType &vector) noexcept;
    explicit v_i32_8(ValueType scalar) noexcept;
    explicit v_i32_8(ValueType x1, ValueType x2, ValueType x3, ValueType x4) noexcept;
    explicit v_i32_8(
        ValueType x1, ValueType x2, ValueType x3, ValueType x4,
        ValueType x5, ValueType x6, ValueType x7, ValueType x8
    ) noexcept;
    explicit v_i32_8(const ValueType *values) noexcept;

    v_i32_8 &operator=(const PackedType &vector) noexcept;
  ...
  void store(const v_i32_8 &src, v_i32_8 *dst) noexcept;

  void store(const v_i32_8 &src, v_i32_8::PackedType *dst) noexcept;

  void store(const v_i32_8 &src, v_i32_8::ValueType *dst) noexcept;
}
