...
namespace vectorization {
  ...
  struct v_f32_4x4 {
    ...
    explicit v_f32_4x4(
        const SOAVectorType::PackedType &soaX, const SOAVectorType::PackedType &soaY,
        const SOAVectorType::PackedType &soaZ, const SOAVectorType::PackedType &soaW
    ) noexcept;

    explicit v_f32_4x4(
        const SOAVectorType &soaX, const SOAVectorType &soaY, const SOAVectorType &soaZ, const SOAVectorType &soaW
    ) noexcept;
