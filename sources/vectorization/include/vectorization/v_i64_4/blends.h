...
namespace vectorization {
  ...
  v_i64_4 blend(const v_i64_4 &a, const v_i64_4 &b) noexcept {
#if VECTORIZATION_INTRINSICS_LEVEL >= VECTORIZATION_AVX
  ...
  template <>
  v_i64_4 blend<false, false, false, false>(const v_i64_4 &a, const v_i64_4 &) noexcept;

  template <>
  v_i64_4 blend<true, true, true, true>(const v_i64_4 &, const v_i64_4 &b) noexcept;

  v_i64_4 blendMasked(const v_i64_4 &a, const v_i64_4 &b, const v_i64_4 &mask) noexcept;
}
