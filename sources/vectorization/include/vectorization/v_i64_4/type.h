...
namespace vectorization {
  struct v_i64_4 {
    ...
    v_i64_4() noexcept;
    v_i64_4(const PackedType &vector) noexcept;
    explicit v_i64_4(ValueType scalar) noexcept;
    explicit v_i64_4(ValueType x, ValueType y, ValueType z, ValueType w) noexcept;
    explicit v_i64_4(const ValueType *values) noexcept;

    v_i64_4 &operator=(const PackedType &vector) noexcept;
  ...
  void store(const v_i64_4 &src, v_i64_4 *dst) noexcept;

  void store(const v_i64_4 &src, v_i64_4::PackedType *dst) noexcept;

  void store(const v_i64_4 &src, v_i64_4::ValueType *dst) noexcept;
}
