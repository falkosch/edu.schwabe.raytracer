...
namespace vectorization {
  ...
  v_f32_4 x_yzw(const v_f32_4 &a, const v_f32_4 &b) noexcept;

  v_f32_4 blendMasked(const v_f32_4 &onBitNotSet, const v_f32_4 &onBitSet, const v_f32_4 &mask) noexcept;
