...
namespace vectorization
{
    ...
    template <
        ASizeT X1, ASizeT X2, ASizeT X3, ASizeT X4,
        ASizeT X5, ASizeT X6, ASizeT X7, ASizeT X8,
        bool SelectX1, bool SelectX2, bool SelectX3, bool SelectX4,
        bool SelectX5, bool SelectX6, bool SelectX7, bool SelectX8
    > inline const PackedFloat8_256 swizzledBlend(const PackedFloat8_256 & a, const PackedFloat8_256 & b) noexcept {
        return blend<
