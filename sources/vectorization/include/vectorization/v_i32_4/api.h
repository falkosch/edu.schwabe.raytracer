...
namespace vectorization {
  ...
  struct v_i32_4 {
    ...
    explicit v_i32_4(const ValueType s) noexcept;

    explicit v_i32_4(const ValueType x, const ValueType y) noexcept;

    explicit v_i32_4(const ValueType x, const ValueType y, const ValueType z) noexcept;
...
#pragma region swizzle()
  ...
  // generic swizzle
  inline const v_i32_4 swizzle(const v_i32_4 &v) noexcept {
...
#pragma region swizzledBlend()
  ...
  inline const v_i32_4 swizzledBlend(const v_i32_4 &a, const v_i32_4 &b) noexcept {
  ...
  template <>
  const v_i32_4 swizzledBlend2x2<VectorIndices::X, VectorIndices::Y, VectorIndices::Z, VectorIndices::W>(
      const v_i32_4 &a, const v_i32_4 &b
  ) noexcept;

  template <>
  const v_i32_4 swizzledBlend2x2<VectorIndices::X, VectorIndices::Y, VectorIndices::X, VectorIndices::Y>(
      const v_i32_4 &a, const v_i32_4 &b
  ) noexcept;

  template <>
  const v_i32_4 swizzledBlend2x2<VectorIndices::Z, VectorIndices::W, VectorIndices::Z, VectorIndices::W>(
      const v_i32_4 &a, const v_i32_4 &b
  ) noexcept;
...
#pragma region replaceComponent()
  ...
  const v_i32_4 replaceComponent(const v_i32_4 &v, const v_i32_4::ValueType s) noexcept;
...
#pragma region component()
  ...
  template <ASizeT Index>
  const v_i32_4::ValueType component(const v_i32_4 &v) noexcept;
