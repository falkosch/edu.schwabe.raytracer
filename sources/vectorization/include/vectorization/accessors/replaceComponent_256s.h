...
namespace vectorization {
  ...
  replaceComponent(const PackedFloat8_256 &v, const PackedFloat8_256 &replacement, const ASizeT index) noexcept;
  const PackedFloat8_256
  replaceComponent(const PackedFloat8_256 &v, const Float_32 replacement, const ASizeT index) noexcept;
}
