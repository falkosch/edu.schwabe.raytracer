...
namespace vectorization {
  ...
  inline const PackedFloat8_256 swizzle(const PackedFloat8_256 &v) noexcept {
    ...
    const auto swizzledX1toX4 =
        swizzle<X1 & VectorIndices::X4, X2 & VectorIndices::X4, X3 & VectorIndices::X4, X4 & VectorIndices::X4>(v);

    const auto swizzledX5toX8 =
        swizzle<X5 & VectorIndices::X4, X6 & VectorIndices::X4, X7 & VectorIndices::X4, X8 & VectorIndices::X4>(v);
