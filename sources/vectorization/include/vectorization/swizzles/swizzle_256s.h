...
namespace vectorization
{
    ...
    inline const PackedFloat8_256 swizzle(const PackedFloat8_256 & v) noexcept {
        ...
        return _mm256_permute_ps(v, PermuteMask);
    }
    ...
    inline const PackedFloat8_256 swizzle(const PackedFloat8_256 & v) noexcept {
        ...
        const auto swizzledX1toX4 = swizzle<
            X1 & VectorIndices::X4, X2 & VectorIndices::X4,
            X3 & VectorIndices::X4, X4 & VectorIndices::X4
        >(v);

        const auto swizzledX5toX8 = swizzle<
            X5 & VectorIndices::X4, X6 & VectorIndices::X4,
            X7 & VectorIndices::X4, X8 & VectorIndices::X4
        >(v);
        ...
        return blend<
            (X1 >= VectorIndices::X5), (X2 >= VectorIndices::X5),
            (X3 >= VectorIndices::X5), (X4 >= VectorIndices::X5),
            (X5 >= VectorIndices::X5), (X6 >= VectorIndices::X5),
            (X7 >= VectorIndices::X5), (X8 >= VectorIndices::X5)
