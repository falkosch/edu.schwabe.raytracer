...
namespace vectorization {
  ...
  v_ui32_8 replaceX1(const v_ui32_8 &v, v_ui32_8::ValueType s) noexcept { return replaceComponent<VectorIndices::X1>(v, s); }
  v_ui32_8 replaceX2(const v_ui32_8 &v, v_ui32_8::ValueType s) noexcept { return replaceComponent<VectorIndices::X2>(v, s); }
  v_ui32_8 replaceX3(const v_ui32_8 &v, v_ui32_8::ValueType s) noexcept { return replaceComponent<VectorIndices::X3>(v, s); }
  v_ui32_8 replaceX4(const v_ui32_8 &v, v_ui32_8::ValueType s) noexcept { return replaceComponent<VectorIndices::X4>(v, s); }
  v_ui32_8 replaceX5(const v_ui32_8 &v, v_ui32_8::ValueType s) noexcept { return replaceComponent<VectorIndices::X5>(v, s); }
  v_ui32_8 replaceX6(const v_ui32_8 &v, v_ui32_8::ValueType s) noexcept { return replaceComponent<VectorIndices::X6>(v, s); }
  v_ui32_8 replaceX7(const v_ui32_8 &v, v_ui32_8::ValueType s) noexcept { return replaceComponent<VectorIndices::X7>(v, s); }
  v_ui32_8 replaceX8(const v_ui32_8 &v, v_ui32_8::ValueType s) noexcept { return replaceComponent<VectorIndices::X8>(v, s); }
}
