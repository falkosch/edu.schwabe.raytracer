...
namespace vectorization
{
    ...
    v_f32_8::v_f32_8(const HalfPackedType& half_to_broadcast) noexcept
    {
#if VECTORIZATION_INTRINSICS_LEVEL >= VECTORIZATION_AVX
        components = _mm256_set_m128(half_to_broadcast, half_to_broadcast);
#else
        components.lo = half_to_broadcast;
        components.hi = half_to_broadcast;
#endif
    }

    v_f32_8::v_f32_8(const HalfVectorType& half_to_broadcast) noexcept : v_f32_8(half_to_broadcast.components)
    {
    }
