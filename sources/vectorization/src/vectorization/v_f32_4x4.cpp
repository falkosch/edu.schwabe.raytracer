...
#pragma region Constructors
    ...
    v_f32_4x4::v_f32_4x4() noexcept
        : soaX(), soaY(), soaZ(), soaW() { }

    v_f32_4x4::v_f32_4x4(const PackedType & soaXIn, const PackedType & soaYIn, const PackedType & soaZIn, const PackedType & soaWIn) noexcept
        : soaX(soaXIn), soaY(soaYIn), soaZ(soaZIn), soaW(soaWIn) { }

    v_f32_4x4::v_f32_4x4(const SOAVectorType & soaXIn, const SOAVectorType & soaYIn, const SOAVectorType & soaZIn, const SOAVectorType & soaWIn) noexcept
        : soaX(soaXIn), soaY(soaYIn), soaZ(soaZIn), soaW(soaWIn) { }
