...
#pragma region v_ui64_2::
  ...
  v_ui64_2::v_ui64_2() noexcept : components(Zero<v_ui64_2::PackedType>()) {
  }

  v_ui64_2::v_ui64_2(const v_ui64_2::PackedType &v) noexcept : components(v) {
  }

#ifdef ARCH_X64
  v_ui64_2::v_ui64_2(const v_ui64_2::ValueType s) noexcept : components(_mm_set1_epi64x(static_cast<long long>(s))) {
  }
...
#else
  v_ui64_2::v_ui64_2(const v_ui64_2::ValueType s) noexcept : components() {
...
#pragma region swizzledBlendMasked()
  ...
  template <>
  const v_ui64_2 swizzledBlendMasked<VectorIndices::X, VectorIndices::Y>(
