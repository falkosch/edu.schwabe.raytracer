...
#pragma region swizzle()
  ...
  template <>
  v_i32_4 swizzle<VectorIndices::X, VectorIndices::Y, VectorIndices::Z, VectorIndices::W>(const v_i32_4 &v
  ) noexcept {
    return v;
  }

  template <>
  v_i32_4 swizzle<VectorIndices::X, VectorIndices::X, VectorIndices::Y, VectorIndices::Y>(const v_i32_4 &v
  ) noexcept {
    return _mm_unpacklo_epi32(v.components, v.components);
  }

  template <>
  v_i32_4 swizzle<VectorIndices::Z, VectorIndices::Z, VectorIndices::W, VectorIndices::W>(const v_i32_4 &v
  ) noexcept {
    return _mm_unpackhi_epi32(v.components, v.components);
  }

  template <>
  v_i32_4 swizzle<VectorIndices::X, VectorIndices::Y, VectorIndices::X, VectorIndices::Y>(const v_i32_4 &v
  ) noexcept {
    return _mm_unpacklo_epi64(v.components, v.components);
  }

  template <>
  v_i32_4 swizzle<VectorIndices::Z, VectorIndices::W, VectorIndices::Z, VectorIndices::W>(const v_i32_4 &v
  ) noexcept {
