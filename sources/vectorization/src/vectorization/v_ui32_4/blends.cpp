...
namespace vectorization {
  template <>
  v_ui32_4 blend<false, false, false, false>(const v_ui32_4 &a, const v_ui32_4 &) noexcept {
    return a;
  }

  template <>
  v_ui32_4 blend<true, true, true, true>(const v_ui32_4 &, const v_ui32_4 &b) noexcept {
    return b;
  }
