...
namespace vectorization {
  ...
  v_ui64_2::v_ui64_2(const v_ui64_2::PackedType &vector) noexcept : components(vector) {
  }

#ifdef ARCH_X64
  v_ui64_2::v_ui64_2(const v_ui64_2::ValueType scalar) noexcept
      : components(_mm_set1_epi64x(static_cast<long long>(scalar))) {
  }
  ...
  v_ui64_2 &v_ui64_2::operator=(const v_ui64_2::PackedType &packed) noexcept {
    components = packed;
    return *this;
  }
