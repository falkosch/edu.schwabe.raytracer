#include "vectorization/v_ui64_4/functions.h"
...
#if VECTORIZATION_INTRINSICS_LEVEL >= VECTORIZATION_AVX2
    return _mm256_movemask_epi8(_mm256_cmpeq_epi64(v.components, Zero<v_ui64_4::PackedType>())) == 0;
#elif VECTORIZATION_INTRINSICS_LEVEL >= VECTORIZATION_AVX
