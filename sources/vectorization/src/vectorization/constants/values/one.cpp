...
namespace vectorization
{
    ...
    PackedFloat4_256 One<PackedFloat4_256>() noexcept
    {
        ...
        return _mm256_castsi256_pd(_mm256_srli_epi64(_mm256_slli_epi64(MaskAll<PackedInts_256>(), 54), 2));
#else
    ...
    {
#if VECTORIZATION_INTRINSICS_LEVEL >= VECTORIZATION_AVX2
        return _mm256_castsi256_ps(_mm256_srli_epi32(_mm256_slli_epi32(MaskAll<PackedInts_256>(), 25), 2));
#else
