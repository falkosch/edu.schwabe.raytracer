...
namespace vectorization {
  ...
  const PackedFloat8_256 MaskXYZ<PackedFloat8_256>() noexcept {
    return _mm256_blend_ps(MaskNone<PackedFloat8_256>(), MaskAll<PackedFloat8_256>(), 0b01110111);
  }

  template <>
  const PackedFloat4_256 MaskXYZ<PackedFloat4_256>() noexcept {
    return _mm256_blend_pd(MaskNone<PackedFloat4_256>(), MaskAll<PackedFloat4_256>(), 0b0111);
  }
}