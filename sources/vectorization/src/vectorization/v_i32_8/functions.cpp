...
namespace vectorization {
  ...
  v_i32_8 min(const v_i32_8 &a, const v_i32_8 &b) noexcept {
    ...
    const auto hi = _mm_min_epi32(_mm256_extractf128_si256(a.components, 1), _mm256_extractf128_si256(b.components, 1));
    return _mm256_insertf128_si256(_mm256_castsi128_si256(lo), hi, 1);
#else
  ...
  v_i32_8 max(const v_i32_8 &a, const v_i32_8 &b) noexcept {
    ...
    const auto hi = _mm_max_epi32(_mm256_extractf128_si256(a.components, 1), _mm256_extractf128_si256(b.components, 1));
    return _mm256_insertf128_si256(_mm256_castsi128_si256(lo), hi, 1);
#else
