...
{
    Float_32 negativeMultiplyAdd(const Float_32 a, const Float_32 b, const Float_32 c) noexcept
    {
        return x(negativeMultiplyAddX(_mm_set_ss(a), _mm_set_ss(b), _mm_set_ss(c)));
    }

    Float_64 negativeMultiplyAdd(const Float_64 a, const Float_64 b, const Float_64 c) noexcept
    {
        return x(negativeMultiplyAddX(_mm_set_sd(a), _mm_set_sd(b), _mm_set_sd(c)));
    }
