...
{
    Float_32 negativeMultiplySub(const Float_32 a, const Float_32 b, const Float_32 c) noexcept
    {
        return x(negativeMultiplySubX(_mm_set_ss(a), _mm_set_ss(b), _mm_set_ss(c)));
    }

    Float_64 negativeMultiplySub(const Float_64 a, const Float_64 b, const Float_64 c) noexcept
    {
        return x(negativeMultiplySubX(_mm_set_sd(a), _mm_set_sd(b), _mm_set_sd(c)));
    }
