...
{
    v_i64_2 sqr(const v_i64_2& v) noexcept
    {
        return v * v;
    }
    ...
    {
        return !_mm_testz_si128(vector.components, MaskAll<v_i64_2::PackedType>());
    }

    bool anyFalse(const v_i64_2& vector) noexcept
    {
        return !_mm_testc_si128(vector.components, MaskAll<v_i64_2::PackedType>());
    }
