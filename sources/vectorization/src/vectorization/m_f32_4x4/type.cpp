...
namespace vectorization {
  ...
  m_f32_4x4::m_f32_4x4() noexcept
      : row0(OneX<RowVectorType>()), row1(OneY<RowVectorType>()),
        row2(OneZ<RowVectorType>()), row3(OneW<RowVectorType>()) {
  }

  m_f32_4x4::m_f32_4x4(
      const RowVectorType &row0In, const RowVectorType &row1In,
      const RowVectorType &row2In, const RowVectorType &row3In
  ) noexcept
      : row0(row0In), row1(row1In), row2(row2In), row3(row3In) {
  }

  m_f32_4x4::m_f32_4x4(const RowVectorType::PackedType &row) noexcept
      : row0(row), row1(row), row2(row), row3(row) {
  }

  m_f32_4x4::m_f32_4x4(const RowVectorType &row) noexcept : row0(row), row1(row), row2(row), row3(row) {
  }
  ...
  m_f32_4x4::m_f32_4x4(const ValueType *const values) noexcept
  ...
  m_f32_4x4 &m_f32_4x4::operator=(const RowVectorType::PackedType &row) noexcept {
    row0 = row;
    row1 = row;
    row2 = row;
    row3 = row;
