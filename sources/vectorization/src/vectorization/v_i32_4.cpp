...
#pragma region v_i32_4::
  ...
  v_i32_4::v_i32_4() noexcept : components(Zero<v_i32_4::PackedType>()) {
  }

  v_i32_4::v_i32_4(const v_i32_4::PackedType &v) noexcept : components(v) {
  }

  v_i32_4::v_i32_4(const v_i32_4::ValueType s) noexcept : components(_mm_set1_epi32(s)) {
  }
  ...
  v_i32_4::v_i32_4(
      const v_i32_4::ValueType x, const v_i32_4::ValueType y, const v_i32_4::ValueType z, const v_i32_4::ValueType w
  ) noexcept
