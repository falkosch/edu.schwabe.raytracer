...
namespace vectorization {
  ...
  blend<false, false, false, false>(const PackedFloat4_128 &a, const PackedFloat4_128 &) noexcept {
    return a;
  }
  ...
  template <>
  const PackedFloat4_128
  blend<false, false, true, true>(const PackedFloat4_128 &a, const PackedFloat4_128 &b) noexcept {
...
#pragma clang diagnostic pop
  ...
  template <>
  const PackedFloat4_128
  blend<true, true, false, false>(const PackedFloat4_128 &a, const PackedFloat4_128 &b) noexcept {
#pragma clang diagnostic push
#pragma ide diagnostic ignored "ArgumentSelectionDefects"
    // argument order is indeed (b, a)
