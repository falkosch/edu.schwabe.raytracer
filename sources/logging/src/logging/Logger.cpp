...
namespace logging {
  ...
  void Logger::workerLoop(std::stop_token stopToken) {
  ...
  std::string Logger::formatEntry(LogEntry &entry) {
    auto message = entry.messageFactory();
  ...
  void Logger::processEntry(LogEntry &entry) {
