...
namespace vectorization::test {
  TEST_CLASS(v_i32_4_AccessorsTest) {
  public:
    ...
    TEST_METHOD(readsXYZW) {
      ...
      {
        const v_i32_4 actual{x(given), y(given), z(given), w(given)};
        Assert::IsTrue(allTrue(given == actual), L"component value mismatch", LINE_INFO());
      }

      {
        const v_i32_4 actual{w(given), x(given), y(given), z(given)};
        Assert::IsTrue(allTrue(given != actual), L"wrong component match", LINE_INFO());
      }
    }

    TEST_METHOD(replacesComponent) {
      const Int_32 givenReplacement = 99;
      const v_i32_4 given{10, 20, 30, 40};

      {
        const v_i32_4 expected{givenReplacement, y(given), z(given), w(given)};
      ...
      {
        const v_i32_4 expected{x(given), givenReplacement, z(given), w(given)};
      ...
      {
        const v_i32_4 expected{x(given), y(given), givenReplacement, w(given)};
      ...
      {
        const v_i32_4 expected{x(given), y(given), z(given), givenReplacement};
