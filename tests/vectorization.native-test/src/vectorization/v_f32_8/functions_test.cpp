...
namespace vectorization::test
{
    TEST_CLASS (v_f32_8_FunctionsTest)
    {
        ...
        TEST_METHOD(sqrComputes)
        {
            const v_f32_8 v(2.0f, 3.0f, 4.0f, 5.0f, -1.0f, 0.0f, 0.5f, -3.0f);
            const auto r = sqr(v);
            Assert::AreEqual(4.0f, x1(r), L"2^2", LINE_INFO());
            Assert::AreEqual(9.0f, x2(r), L"3^2", LINE_INFO());
            Assert::AreEqual(16.0f, x3(r), L"4^2", LINE_INFO());
            Assert::AreEqual(25.0f, x4(r), L"5^2", LINE_INFO());
            Assert::AreEqual(1.0f, x5(r), L"(-1)^2", LINE_INFO());
            Assert::AreEqual(0.0f, x6(r), L"0^2", LINE_INFO());
            Assert::AreEqual(0.25f, x7(r), L"0.5^2", LINE_INFO());
            Assert::AreEqual(9.0f, x8(r), L"(-3)^2", LINE_INFO());
        }
