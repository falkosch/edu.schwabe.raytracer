...
namespace vectorization::test
{
    TEST_CLASS (NegativeMultiplySubTest)
    {
        public
        :
        TEST_METHOD(negativeMultiplySubsFloat32)
        {
            Assert::AreEqual(-14.0f, negativeMultiplySub(2.0f, 3.0f, 8.0f), L"-(2*3)-8", LINE_INFO());
            Assert::AreEqual(-0.5f, negativeMultiplySub(0.0f, 5.0f, 0.5f), L"-(0*5)-0.5", LINE_INFO());
            Assert::AreEqual(1.0f, negativeMultiplySub(2.0f, 3.0f, -7.0f), L"-(2*3)-(-7)", LINE_INFO());
        }

        TEST_METHOD(negativeMultiplySubsFloat64)
        {
            Assert::AreEqual(-14.0, negativeMultiplySub(2.0, 3.0, 8.0), L"-(2*3)-8", LINE_INFO());
            Assert::AreEqual(-0.5, negativeMultiplySub(0.0, 5.0, 0.5), L"-(0*5)-0.5", LINE_INFO());
            Assert::AreEqual(1.0, negativeMultiplySub(2.0, 3.0, -7.0), L"-(2*3)-(-7)", LINE_INFO());
        }
