...
namespace vectorization::test {
  ...
  public:
    TEST_METHOD(readsComponent) {
...

      {
        std::array<Float_32, VectorSizes::X8> actual{
            component<VectorIndices::X1>(givenPack), component<VectorIndices::X2>(givenPack),
      ...
      {
        std::array<Float_32, VectorSizes::X8> actual{
            component<VectorIndices::X8>(givenPack), component<VectorIndices::X1>(givenPack),
    ...
    TEST_METHOD(readsXYZW) {
      ...
      {
        std::vector<Float_32> actual{x(givenPack), y(givenPack), z(givenPack), w(givenPack)};
        Assert::AreEqual(expectedComponents, actual, L"component value mismatch", LINE_INFO());
      }

      {
        std::vector<Float_32> actual{w(givenPack), x(givenPack), y(givenPack), z(givenPack)};
        Assert::AreNotEqual(expectedComponents, actual, L"wrong component match", LINE_INFO());
      }
    }
    ...
    TEST_METHOD(readsXi) {
      ...
      {
        std::array<Float_32, VectorSizes::X8> actual{x1(givenPack), x2(givenPack), x3(givenPack), x4(givenPack),
                                                     x5(givenPack), x6(givenPack), x7(givenPack), x8(givenPack)};
        Assert::AreEqual(expectedComponents, actual, L"component value mismatch", LINE_INFO());
      }

      {
        std::array<Float_32, VectorSizes::X8> actual{x8(givenPack), x1(givenPack), x2(givenPack), x3(givenPack),
