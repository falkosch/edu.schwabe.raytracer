        ...
        public:
            ...
            TEST_METHOD(variadicBlendsTwoFloat8_32WithFloat8_32BitMask) {
...

                {
                    ...
                    _mm256_store_ps(actual.data(), blendMasked(givenOnBitNotSetPack, givenOnBitSetPack, MaskNone<PackedFloat8_256>()));
...

                {
                    ...
                    _mm256_store_ps(actual.data(), blendMasked(givenOnBitNotSetPack, givenOnBitSetPack, MaskXY<PackedFloat8_256>()));
                    Assert::AreEqual(expected, actual, L"blend masked value mismatch", LINE_INFO());
                }

                {
                    ...
                    _mm256_store_ps(actual.data(), blendMasked(givenOnBitNotSetPack, givenOnBitSetPack, MaskXYZ<PackedFloat8_256>()));
                    Assert::AreEqual(expected, actual, L"blend masked value mismatch", LINE_INFO());
                }

                {
                    ...
                    _mm256_store_ps(actual.data(), blendMasked(givenOnBitNotSetPack, givenOnBitSetPack, MaskXYZW<PackedFloat8_256>()));
                    Assert::AreEqual(expected, actual, L"blend masked value mismatch", LINE_INFO());
                }
            }
            ...
            TEST_METHOD(variadicBlendsTwoFloat8_32WithBool8_32BitMask) {
...

                {
                    ...
                    _mm256_store_ps(actual.data(), blendMasked(givenOnBitNotSetPack, givenOnBitSetPack, _mm256_castps_si256(MaskNone<PackedFloat8_256>())));
                    Assert::AreEqual(expected, actual, L"blend masked value mismatch", LINE_INFO());
                }

                {
                    ...
                    _mm256_store_ps(actual.data(), blendMasked(givenOnBitNotSetPack, givenOnBitSetPack, _mm256_castps_si256(MaskX<PackedFloat8_256>())));
                    Assert::AreEqual(expected, actual, L"blend masked value mismatch", LINE_INFO());
                }

                {
                    ...
                    _mm256_store_ps(actual.data(), blendMasked(givenOnBitNotSetPack, givenOnBitSetPack, _mm256_castps_si256(MaskXY<PackedFloat8_256>())));
                    Assert::AreEqual(expected, actual, L"blend masked value mismatch", LINE_INFO());
                }

                {
                    ...
                    _mm256_store_ps(actual.data(), blendMasked(givenOnBitNotSetPack, givenOnBitSetPack, _mm256_castps_si256(MaskXYZ<PackedFloat8_256>())));
                    Assert::AreEqual(expected, actual, L"blend masked value mismatch", LINE_INFO());
                }

                {
                    ...
                    _mm256_store_ps(actual.data(), blendMasked(givenOnBitNotSetPack, givenOnBitSetPack, _mm256_castps_si256(MaskXYZW<PackedFloat8_256>())));
                    Assert::AreEqual(expected, actual, L"blend masked value mismatch", LINE_INFO());
                }
            }
        };
