        ...
        public:
            ...
            TEST_METHOD(genericallySwizzleBlendsIdentity) {
...

                {
                    ...
                    _mm256_store_ps(actual.data(), swizzledBlend<
            ...
            TEST_METHOD(genericallySwizzleBlendsBroadcast) {
                ...
                {
                    std::array<Float_32, VectorSizes::X8> expected{
                        givenOnBitNotSet.at(VectorIndices::X1), givenOnBitNotSet.at(VectorIndices::X1), givenOnBitNotSet.at(VectorIndices::X1), givenOnBitNotSet.at(VectorIndices::X1),
                        givenOnBitNotSet.at(VectorIndices::X1), givenOnBitNotSet.at(VectorIndices::X1), givenOnBitNotSet.at(VectorIndices::X1), givenOnBitNotSet.at(VectorIndices::X1)
                    };
                    _mm256_store_ps(actual.data(), swizzledBlend<
                ...
                {
                    std::array<Float_32, VectorSizes::X8> expected{
                        givenOnBitSet.at(VectorIndices::X2), givenOnBitSet.at(VectorIndices::X2), givenOnBitSet.at(VectorIndices::X2), givenOnBitSet.at(VectorIndices::X2),
                        givenOnBitSet.at(VectorIndices::X3), givenOnBitSet.at(VectorIndices::X3), givenOnBitSet.at(VectorIndices::X3), givenOnBitSet.at(VectorIndices::X3)
                    };
                    _mm256_store_ps(actual.data(), swizzledBlend<
                ...
                {
                    std::array<Float_32, VectorSizes::X8> expected{
                        givenOnBitNotSet.at(VectorIndices::X5), givenOnBitNotSet.at(VectorIndices::X5), givenOnBitNotSet.at(VectorIndices::X5), givenOnBitNotSet.at(VectorIndices::X5),
                        givenOnBitSet.at(VectorIndices::X4), givenOnBitSet.at(VectorIndices::X4), givenOnBitSet.at(VectorIndices::X4), givenOnBitSet.at(VectorIndices::X4)
                    };
                    _mm256_store_ps(actual.data(), swizzledBlend<
                ...
                {
                    std::array<Float_32, VectorSizes::X8> expected{
                        givenOnBitSet.at(VectorIndices::X6), givenOnBitSet.at(VectorIndices::X6), givenOnBitSet.at(VectorIndices::X6), givenOnBitSet.at(VectorIndices::X6),
                        givenOnBitNotSet.at(VectorIndices::X7), givenOnBitNotSet.at(VectorIndices::X7), givenOnBitNotSet.at(VectorIndices::X7), givenOnBitNotSet.at(VectorIndices::X7)
                    };
                    _mm256_store_ps(actual.data(), swizzledBlend<
            ...
            TEST_METHOD(genericallySwizzleBlendsAny) {
                ...
                {
                    std::array<Float_32, VectorSizes::X8> expected{
                        givenOnBitSet.at(VectorIndices::X6), givenOnBitNotSet.at(VectorIndices::X6), givenOnBitSet.at(VectorIndices::X6), givenOnBitNotSet.at(VectorIndices::X6),
                        givenOnBitNotSet.at(VectorIndices::X7), givenOnBitSet.at(VectorIndices::X7), givenOnBitNotSet.at(VectorIndices::X7), givenOnBitSet.at(VectorIndices::X7)
                    };
                    _mm256_store_ps(actual.data(), swizzledBlend<
                        VectorIndices::X6, VectorIndices::X6, VectorIndices::X6, VectorIndices::X6,
                        VectorIndices::X7, VectorIndices::X7, VectorIndices::X7, VectorIndices::X7,
                ...
                {
                    std::array<Float_32, VectorSizes::X8> expected{
                        givenOnBitNotSet.at(VectorIndices::X8), givenOnBitNotSet.at(VectorIndices::X7), givenOnBitSet.at(VectorIndices::X6), givenOnBitSet.at(VectorIndices::X5),
                        givenOnBitSet.at(VectorIndices::X8), givenOnBitNotSet.at(VectorIndices::X6), givenOnBitNotSet.at(VectorIndices::X4), givenOnBitNotSet.at(VectorIndices::X2)
                    };
                    _mm256_store_ps(actual.data(), swizzledBlend<
                        VectorIndices::X8, VectorIndices::X7, VectorIndices::X6, VectorIndices::X5,
                        VectorIndices::X8, VectorIndices::X6, VectorIndices::X4, VectorIndices::X2,
