...
namespace vectorization::test {
  ...
  public:
    ...
    TEST_METHOD(genericallySwizzleBlendsBroadcast) {
      ...
      {
        constexpr std::array expected{givenOnBitNotSet.at(VectorIndices::X1), givenOnBitNotSet.at(VectorIndices::X1),
      ...
      {
        constexpr std::array expected{givenOnBitSet.at(VectorIndices::X2), givenOnBitSet.at(VectorIndices::X2),
      ...
      {
        constexpr std::array expected{givenOnBitNotSet.at(VectorIndices::X5), givenOnBitNotSet.at(VectorIndices::X5),
      ...
      {
        constexpr std::array expected{givenOnBitSet.at(VectorIndices::X6),    givenOnBitSet.at(VectorIndices::X6),
    ...
    TEST_METHOD(genericallySwizzleBlendsAny) {
      ...
      {
        constexpr std::array expected{givenOnBitSet.at(VectorIndices::X6),    givenOnBitNotSet.at(VectorIndices::X6),
      ...
      {
        constexpr std::array expected{givenOnBitNotSet.at(VectorIndices::X8), givenOnBitNotSet.at(VectorIndices::X7),
