...
namespace vectorization::test {
  TEST_CLASS(v_i64_4_AccessorsTest) {
  public:
    ...
    TEST_METHOD(readsXYZW) {
      ...
      {
        const v_i64_4 actual{x(given), y(given), z(given), w(given)};
        Assert::IsTrue(allTrue(given == actual), L"component value mismatch", LINE_INFO());
      }

      {
        const v_i64_4 actual{w(given), x(given), y(given), z(given)};
        Assert::IsTrue(allTrue(given != actual), L"wrong component match", LINE_INFO());
      }
    }

    TEST_METHOD(replacesComponent) {
      const Int_64 givenReplacement = 99LL;
      const v_i64_4 given{10LL, 20LL, 30LL, 40LL};

      {
        const v_i64_4 expected{givenReplacement, y(given), z(given), w(given)};
      ...
      {
        const v_i64_4 expected{x(given), givenReplacement, z(given), w(given)};
      ...
      {
        const v_i64_4 expected{x(given), y(given), givenReplacement, w(given)};
      ...
      {
        const v_i64_4 expected{x(given), y(given), z(given), givenReplacement};
