    ...
    namespace test
    {
        ...
        public:
            ...
            TEST_METHOD(genericallySwizzlesIdentityAndItsReverse) {
                ...
                {
                    v_f32_4 expected{
                        w(given), z(given), y(given), x(given)
                    };
            ...
            TEST_METHOD(genericallySwizzlesBroadcast) {
                ...
                {
                    v_f32_4 expected{
                        x(given), x(given), x(given), x(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        y(given), y(given), y(given), y(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        z(given), z(given), z(given), z(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        w(given), w(given), w(given), w(given)
                    };
            ...
            TEST_METHOD(genericallySwizzlesDuplicateForms) {
                ...
                {
                    v_f32_4 expected{
                        x(given), x(given), y(given), y(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        x(given), x(given), z(given), z(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        x(given), y(given), x(given), y(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        y(given), y(given), w(given), w(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        z(given), z(given), w(given), w(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        z(given), w(given), z(given), w(given)
                    };
            ...
            TEST_METHOD(hasShortFormsForSwizzlesOfXFirst) {
                ...
                {
                    v_f32_4 expected{
                        x(given), x(given), x(given), z(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        x(given), z(given), z(given), z(given)
                    };
            ...
            TEST_METHOD(hasShortFormsForSwizzlesOfYFirst) {
                ...
                {
                    v_f32_4 expected{
                        y(given), x(given), x(given), y(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        y(given), x(given), w(given), z(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        y(given), z(given), x(given), w(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        y(given), z(given), w(given), x(given)
                    };
            ...
            TEST_METHOD(hasShortFormsForSwizzlesOfZFirst) {
                ...
                {
                    v_f32_4 expected{
                        z(given), x(given), y(given), w(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        z(given), z(given), y(given), y(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        z(given), w(given), x(given), y(given)
                    };
