  ...
  public:
    TEST_METHOD(computesLog) {
      ...
      auto matchers = {Compare::equalsOrdered<v_f32_4>, // Zero
                       ...
                       Compare::isBothNotANumber<v_f32_4>,   Compare::nearEqualsRelative<v_f32_4>,
                       Compare::isBothNotANumber<v_f32_4>,
                       ...
                       Compare::isBothNotANumber<v_f32_4>,   Compare::equalsOrdered<v_f32_4>,
                       Compare::isBothNotANumber<v_f32_4>,
                       ...
                       Compare::isBothNotANumber<v_f32_4>,   Compare::isBothNotANumber<v_f32_4>};
    ...
    TEST_METHOD(computesExp) {
      ...
      auto matchers = {Compare::nearEqualsRelative<v_f32_4>, // Zero
                       ...
                       Compare::nearEqualsRelative<v_f32_4>,
                       Compare::nearEqualsRelative<v_f32_4>, // Sin45
                       Compare::nearEqualsRelative<v_f32_4>, Compare::equalsOrdered<v_f32_4>,
                       ...
                       Compare::nearEqualsRelative<v_f32_4>,
                       Compare::nearEqualsRelative<v_f32_4>, // round_error
                       Compare::nearEqualsRelative<v_f32_4>, Compare::isBothNotANumber<v_f32_4>};
