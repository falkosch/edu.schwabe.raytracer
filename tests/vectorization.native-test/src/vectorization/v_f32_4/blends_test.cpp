...
namespace vectorization::test {
  ...
  public:
    ...
    TEST_METHOD(genericallyBlendsIndividuals) {
      ...
      {
        v_f32_4 expected{x(givenOnBitSet), y(givenOnBitNotSet), z(givenOnBitNotSet), w(givenOnBitNotSet)};
        auto actual = blend<true, false, false, false>(givenOnBitNotSet, givenOnBitSet);
        Assert::IsTrue(allTrue(expected == actual), L"blend value mismatch", LINE_INFO());
      }

      {
        v_f32_4 expected{x(givenOnBitNotSet), y(givenOnBitSet), z(givenOnBitNotSet), w(givenOnBitNotSet)};
        auto actual = blend<false, true, false, false>(givenOnBitNotSet, givenOnBitSet);
        Assert::IsTrue(allTrue(expected == actual), L"blend value mismatch", LINE_INFO());
      }

      {
        v_f32_4 expected{x(givenOnBitNotSet), y(givenOnBitNotSet), z(givenOnBitSet), w(givenOnBitNotSet)};
        auto actual = blend<false, false, true, false>(givenOnBitNotSet, givenOnBitSet);
        Assert::IsTrue(allTrue(expected == actual), L"blend value mismatch", LINE_INFO());
      }

      {
        v_f32_4 expected{x(givenOnBitNotSet), y(givenOnBitNotSet), z(givenOnBitNotSet), w(givenOnBitSet)};
    ...
    TEST_METHOD(genericallyBlendsPairs) {
      ...
      {
        v_f32_4 expected{x(givenOnBitSet), y(givenOnBitSet), z(givenOnBitNotSet), w(givenOnBitNotSet)};
        auto actual = blend<true, true, false, false>(givenOnBitNotSet, givenOnBitSet);
        Assert::IsTrue(allTrue(expected == actual), L"blend value mismatch", LINE_INFO());
      }

      {
        v_f32_4 expected{x(givenOnBitSet), y(givenOnBitNotSet), z(givenOnBitSet), w(givenOnBitNotSet)};
        auto actual = blend<true, false, true, false>(givenOnBitNotSet, givenOnBitSet);
        Assert::IsTrue(allTrue(expected == actual), L"blend value mismatch", LINE_INFO());
      }

      {
        v_f32_4 expected{x(givenOnBitNotSet), y(givenOnBitSet), z(givenOnBitNotSet), w(givenOnBitSet)};
        auto actual = blend<false, true, false, true>(givenOnBitNotSet, givenOnBitSet);
        Assert::IsTrue(allTrue(expected == actual), L"blend value mismatch", LINE_INFO());
      }

      {
        v_f32_4 expected{x(givenOnBitNotSet), y(givenOnBitNotSet), z(givenOnBitSet), w(givenOnBitSet)};
    ...
    TEST_METHOD(genericallyBlendsTriplets) {
      ...
      {
        v_f32_4 expected{x(givenOnBitSet), y(givenOnBitNotSet), z(givenOnBitSet), w(givenOnBitSet)};
        auto actual = blend<true, false, true, true>(givenOnBitNotSet, givenOnBitSet);
        Assert::IsTrue(allTrue(expected == actual), L"blend value mismatch", LINE_INFO());
      }

      {
        v_f32_4 expected{x(givenOnBitSet), y(givenOnBitSet), z(givenOnBitNotSet), w(givenOnBitSet)};
        auto actual = blend<true, true, false, true>(givenOnBitNotSet, givenOnBitSet);
        Assert::IsTrue(allTrue(expected == actual), L"blend value mismatch", LINE_INFO());
      }

      {
        v_f32_4 expected{x(givenOnBitSet), y(givenOnBitSet), z(givenOnBitSet), w(givenOnBitNotSet)};
