...
namespace vectorization::test {
  ...
  public:
    TEST_METHOD(definesArchitecture) {
      ...
      Assert::IsTrue(std::is_same<Float_32, v_f32_4::ValueType>::value, L"Value type mismatch", LINE_INFO());
      Assert::IsTrue(std::is_same<Int_32, v_f32_4::BoolType>::value, L"Bool type mismatch", LINE_INFO());
      Assert::IsTrue(std::is_same<v_f32_4, v_f32_4::VectorType>::value, L"Vector type mismatch", LINE_INFO());
      Assert::IsTrue(std::is_same<v_i32_4, v_f32_4::VectorBoolType>::value, L"Vector bool type mismatch", LINE_INFO());
      Assert::IsTrue(
          std::is_same<PackedTypes<Float_32, VectorSizes::W>::Type, v_f32_4::PackedType>::value,
          L"Packed type mismatch", LINE_INFO()
      );
    }
