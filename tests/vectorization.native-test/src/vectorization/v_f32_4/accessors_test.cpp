    ...
    namespace test
    {
        ...
        public:
            ...
            TEST_METHOD(replacesComponent) {
                ...
                {
                    v_f32_4 expected{
                        givenReplacement, y(given), z(given), w(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        x(given), givenReplacement, z(given), w(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        x(given), y(given), givenReplacement, w(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        x(given), y(given), z(given), givenReplacement
                    };
            ...
            TEST_METHOD(replacesXi) {
                ...
                {
                    v_f32_4 expected{
                        givenReplacement, x2(given), x3(given), x4(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        x1(given), givenReplacement, x3(given), x4(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        x1(given), x2(given), givenReplacement, x4(given)
                    };
                ...
                {
                    v_f32_4 expected{
                        x1(given), x2(given), x3(given), givenReplacement
                    };
