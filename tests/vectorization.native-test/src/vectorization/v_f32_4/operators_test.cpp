...
namespace vectorization::test {
  ...
  public:
    ...
    TEST_METHOD(testAddLeftHandValueOperator) {
      auto expected = v_f32_4(One<v_f32_4::ValueType>(), Two<v_f32_4::ValueType>(), Infinity<v_f32_4::ValueType>());
    ...
    TEST_METHOD(testSubtractVectorOperator) {
      auto expected = v_f32_4(Zero<v_f32_4::ValueType>(), Two<v_f32_4::ValueType>(), Infinity<v_f32_4::ValueType>());
      auto actual = sampleVector1() - sampleVector2();
