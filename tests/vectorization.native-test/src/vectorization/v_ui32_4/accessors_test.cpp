...
namespace vectorization::test {
  TEST_CLASS(v_ui32_4_AccessorsTest) {
  public:
    ...
    TEST_METHOD(readsXYZW) {
      ...
      {
        const v_ui32_4 actual{x(given), y(given), z(given), w(given)};
        Assert::IsTrue(allTrue(given == actual), L"component value mismatch", LINE_INFO());
      }

      {
        const v_ui32_4 actual{w(given), x(given), y(given), z(given)};
        Assert::IsTrue(allTrue(given != actual), L"wrong component match", LINE_INFO());
      }
    }

    TEST_METHOD(replacesComponent) {
      const UInt_32 givenReplacement = 99u;
      const v_ui32_4 given{10u, 20u, 30u, 40u};

      {
        const v_ui32_4 expected{givenReplacement, y(given), z(given), w(given)};
      ...
      {
        const v_ui32_4 expected{x(given), givenReplacement, z(given), w(given)};
      ...
      {
        const v_ui32_4 expected{x(given), y(given), givenReplacement, w(given)};
      ...
      {
        const v_ui32_4 expected{x(given), y(given), z(given), givenReplacement};
