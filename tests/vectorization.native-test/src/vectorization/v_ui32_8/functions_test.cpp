...
namespace vectorization::test {
  ...
  public:
    ...
    TEST_METHOD(checksAllTrue) {
      ...
      Assert::IsFalse(
          allTrue(v_ui32_8{0xFFFFFFFFu, 0xFFFFFFFFu, 0xFFFFFFFFu, 0xFFFFFFFFu, 0xFFFFFFFFu, 0u, 0xFFFFFFFFu, 0xFFFFFFFFu}),
    ...
    TEST_METHOD(checksAnyFalse) {
      Assert::IsTrue(
          anyFalse(v_ui32_8{0xFFFFFFFFu, 0xFFFFFFFFu, 0xFFFFFFFFu, 0u, 0xFFFFFFFFu, 0xFFFFFFFFu, 0xFFFFFFFFu, 0xFFFFFFFFu}),
    ...
    TEST_METHOD(checksAllFalse) {
      ...
      Assert::IsFalse(allFalse(v_ui32_8{0u, 1u, 0u, 0u, 0u, 0u, 0u, 0u}), L"allFalse with one nonzero", LINE_INFO());
    }
  };
}
