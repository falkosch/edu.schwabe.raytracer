...
namespace vectorization
{
    namespace test
    {
        TEST_CLASS(ValueRadianToUniformTest)
        {
        public:

            TEST_METHOD(returnsFloat_32) {
                Assert::AreNotEqual(0.0f, RadianToUniform<Float_32>());
            }

            TEST_METHOD(returnsFloat_64) {
                Assert::AreNotEqual(0.0, RadianToUniform<Float_64>());
            }
            ...
            TEST_METHOD(returnsPackedFloat2_128) {
                ...
                _mm_store_pd(actual.data(), RadianToUniform<PackedFloat2_128>());
            ...
            TEST_METHOD(returnsPackedFloat4_128) {
                ...
                _mm_store_ps(actual.data(), RadianToUniform<PackedFloat4_128>());
                Assert::AreNotEqual(notExpected, actual);
            }
            ...
            TEST_METHOD(returnsPackedFloat4_256) {
                ...
                _mm256_store_pd(actual.data(), RadianToUniform<PackedFloat4_256>());
                Assert::AreNotEqual(notExpected, actual);
            }
            ...
            TEST_METHOD(returnsPackedFloat8_256) {
                ...
                _mm256_store_ps(actual.data(), RadianToUniform<PackedFloat8_256>());
                Assert::AreNotEqual(notExpected, actual);
            }
        };
    }
