...
namespace vectorization::test {
  ...
  public:
    ...
    TEST_METHOD(returnsPackedFloat2_128) {
      std::array<Float_64, VectorSizes::Y> expected{0.5, 0.5};
    ...
    TEST_METHOD(returnsPackedFloat4_128) {
      std::array<Float_32, VectorSizes::W> expected{0.5f, 0.5f, 0.5f, 0.5f};
    ...
    TEST_METHOD(returnsPackedFloat4_256) {
      std::array<Float_64, VectorSizes::W> expected{0.5, 0.5, 0.5, 0.5};
    ...
    TEST_METHOD(returnsPackedFloat8_256) {
      std::array<Float_32, VectorSizes::X8> expected{0.5f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f};
