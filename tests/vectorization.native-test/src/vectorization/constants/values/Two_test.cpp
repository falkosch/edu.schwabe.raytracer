...
namespace vectorization::test {
  ...
  public:
    ...
    TEST_METHOD(returnsPackedFloat2_128) {
      constexpr std::array expected{2.0, 2.0};
    ...
    TEST_METHOD(returnsPackedFloat4_128) {
      constexpr std::array expected{2.0f, 2.0f, 2.0f, 2.0f};
    ...
    TEST_METHOD(returnsPackedFloat4_256) {
      constexpr std::array expected{2.0, 2.0, 2.0, 2.0};
    ...
    TEST_METHOD(returnsPackedFloat8_256) {
      constexpr std::array expected{2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f, 2.0f};
