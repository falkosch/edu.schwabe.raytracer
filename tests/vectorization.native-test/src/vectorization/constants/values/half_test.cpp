...
namespace vectorization::test {
  ...
  public:
    ...
    TEST_METHOD(returnsPackedFloat2_128) {
      constexpr std::array expected{0.5, 0.5};
    ...
    TEST_METHOD(returnsPackedFloat4_128) {
      constexpr std::array expected{0.5f, 0.5f, 0.5f, 0.5f};
    ...
    TEST_METHOD(returnsPackedFloat4_256) {
      constexpr std::array expected{0.5, 0.5, 0.5, 0.5};
    ...
    TEST_METHOD(returnsPackedFloat8_256) {
      constexpr std::array expected{0.5f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f, 0.5f};
