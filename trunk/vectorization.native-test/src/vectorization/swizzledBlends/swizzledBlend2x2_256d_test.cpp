        ...
        public:
            ...
            TEST_METHOD(genericallySwizzleBlendsIdentityAndItsReverse) {
...

                {
                    ...
                    _mm256_store_pd(actual.data(), swizzledBlend2x2<
                ...
                {
                    std::array<Float_64, VectorSizes::W> expected{
                        givenOnBitNotSet.at(VectorIndices::W), givenOnBitNotSet.at(VectorIndices::Z), givenOnBitSet.at(VectorIndices::Y), givenOnBitSet.at(VectorIndices::X)
                    };
                    _mm256_store_pd(actual.data(), swizzledBlend2x2<
            ...
            TEST_METHOD(genericallySwizzleBlendsBroadcast) {
                ...
                {
                    std::array<Float_64, VectorSizes::W> expected{
                        givenOnBitNotSet.at(VectorIndices::X), givenOnBitNotSet.at(VectorIndices::X), givenOnBitSet.at(VectorIndices::X), givenOnBitSet.at(VectorIndices::X)
                    };
                    _mm256_store_pd(actual.data(), swizzledBlend2x2<
                ...
                {
                    std::array<Float_64, VectorSizes::W> expected{
                        givenOnBitNotSet.at(VectorIndices::Y), givenOnBitNotSet.at(VectorIndices::Y), givenOnBitSet.at(VectorIndices::Y), givenOnBitSet.at(VectorIndices::Y)
                    };
                    _mm256_store_pd(actual.data(), swizzledBlend2x2<
                ...
                {
                    std::array<Float_64, VectorSizes::W> expected{
                        givenOnBitNotSet.at(VectorIndices::Z), givenOnBitNotSet.at(VectorIndices::Z), givenOnBitSet.at(VectorIndices::Z), givenOnBitSet.at(VectorIndices::Z)
                    };
                    _mm256_store_pd(actual.data(), swizzledBlend2x2<
                ...
                {
                    std::array<Float_64, VectorSizes::W> expected{
                        givenOnBitNotSet.at(VectorIndices::W), givenOnBitNotSet.at(VectorIndices::W), givenOnBitSet.at(VectorIndices::W), givenOnBitSet.at(VectorIndices::W)
                    };
                    _mm256_store_pd(actual.data(), swizzledBlend2x2<
            ...
            TEST_METHOD(hasShortFormsForSwizzleBlends) {
                ...
                {
                    std::array<Float_64, VectorSizes::W> expected{
                        givenOnBitNotSet.at(VectorIndices::X), givenOnBitNotSet.at(VectorIndices::X), givenOnBitSet.at(VectorIndices::Y), givenOnBitSet.at(VectorIndices::Y)
                    };
                ...
                {
                    std::array<Float_64, VectorSizes::W> expected{
                        givenOnBitNotSet.at(VectorIndices::X), givenOnBitNotSet.at(VectorIndices::Y), givenOnBitSet.at(VectorIndices::X), givenOnBitSet.at(VectorIndices::Y)
                    };
                ...
                {
                    std::array<Float_64, VectorSizes::W> expected{
                        givenOnBitNotSet.at(VectorIndices::X), givenOnBitNotSet.at(VectorIndices::Z), givenOnBitSet.at(VectorIndices::X), givenOnBitSet.at(VectorIndices::Z)
                    };
                ...
                {
                    std::array<Float_64, VectorSizes::W> expected{
                        givenOnBitNotSet.at(VectorIndices::Y), givenOnBitNotSet.at(VectorIndices::X), givenOnBitSet.at(VectorIndices::X), givenOnBitSet.at(VectorIndices::Y)
                    };
                ...
                {
                    std::array<Float_64, VectorSizes::W> expected{
                        givenOnBitNotSet.at(VectorIndices::Y), givenOnBitNotSet.at(VectorIndices::W), givenOnBitSet.at(VectorIndices::Y), givenOnBitSet.at(VectorIndices::W)
                    };
                ...
                {
                    std::array<Float_64, VectorSizes::W> expected{
                        givenOnBitNotSet.at(VectorIndices::Z), givenOnBitNotSet.at(VectorIndices::Z), givenOnBitSet.at(VectorIndices::Y), givenOnBitSet.at(VectorIndices::Y)
                    };
                ...
                {
                    std::array<Float_64, VectorSizes::W> expected{
                        givenOnBitNotSet.at(VectorIndices::Z), givenOnBitNotSet.at(VectorIndices::W), givenOnBitSet.at(VectorIndices::Z), givenOnBitSet.at(VectorIndices::W)
                    };
