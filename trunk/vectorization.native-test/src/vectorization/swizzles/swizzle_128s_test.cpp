        ...
        public:
            ...
            TEST_METHOD(genericallySwizzlesIdentityAndItsReverse) {
...

                {
                    ...
                    _mm_store_ps(actual.data(), swizzle<VectorIndices::X, VectorIndices::Y, VectorIndices::Z, VectorIndices::W>(givenPack));
...

                {
                    ...
                    _mm_store_ps(actual.data(), swizzle<VectorIndices::W, VectorIndices::Z, VectorIndices::Y, VectorIndices::X>(givenPack));
                    Assert::AreEqual(expected, actual, L"swizzle value mismatch", LINE_INFO());
                }
            }
            ...
            TEST_METHOD(genericallySwizzlesBroadcast) {
...

                {
                    ...
                    _mm_store_ps(actual.data(), swizzle<VectorIndices::X, VectorIndices::X, VectorIndices::X, VectorIndices::X>(givenPack));
                    Assert::AreEqual(expected, actual, L"swizzle value mismatch", LINE_INFO());
                }

                {
                    ...
                    _mm_store_ps(actual.data(), swizzle<VectorIndices::Y, VectorIndices::Y, VectorIndices::Y, VectorIndices::Y>(givenPack));
                    Assert::AreEqual(expected, actual, L"swizzle value mismatch", LINE_INFO());
                }

                {
                    ...
                    _mm_store_ps(actual.data(), swizzle<VectorIndices::Z, VectorIndices::Z, VectorIndices::Z, VectorIndices::Z>(givenPack));
                    Assert::AreEqual(expected, actual, L"swizzle value mismatch", LINE_INFO());
                }

                {
                    ...
                    _mm_store_ps(actual.data(), swizzle<VectorIndices::W, VectorIndices::W, VectorIndices::W, VectorIndices::W>(givenPack));
                    Assert::AreEqual(expected, actual, L"swizzle value mismatch", LINE_INFO());
                }
            }
            ...
            TEST_METHOD(genericallySwizzlesDuplicateForms) {
...

                {
                    ...
                    _mm_store_ps(actual.data(), swizzle<VectorIndices::X, VectorIndices::X, VectorIndices::Y, VectorIndices::Y>(givenPack));
                    Assert::AreEqual(expected, actual, L"swizzle value mismatch", LINE_INFO());
                }

                {
                    ...
                    _mm_store_ps(actual.data(), swizzle<VectorIndices::X, VectorIndices::X, VectorIndices::Z, VectorIndices::Z>(givenPack));
                    Assert::AreEqual(expected, actual, L"swizzle value mismatch", LINE_INFO());
                }

                {
                    ...
                    _mm_store_ps(actual.data(), swizzle<VectorIndices::X, VectorIndices::Y, VectorIndices::X, VectorIndices::Y>(givenPack));
                    Assert::AreEqual(expected, actual, L"swizzle value mismatch", LINE_INFO());
                }

                {
                    ...
                    _mm_store_ps(actual.data(), swizzle<VectorIndices::Y, VectorIndices::Y, VectorIndices::W, VectorIndices::W>(givenPack));
                    Assert::AreEqual(expected, actual, L"swizzle value mismatch", LINE_INFO());
                }

                {
                    ...
                    _mm_store_ps(actual.data(), swizzle<VectorIndices::Z, VectorIndices::Z, VectorIndices::W, VectorIndices::W>(givenPack));
                    Assert::AreEqual(expected, actual, L"swizzle value mismatch", LINE_INFO());
                }

                {
                    ...
                    _mm_store_ps(actual.data(), swizzle<VectorIndices::Z, VectorIndices::W, VectorIndices::Z, VectorIndices::W>(givenPack));
                    Assert::AreEqual(expected, actual, L"swizzle value mismatch", LINE_INFO());
                }
            }
