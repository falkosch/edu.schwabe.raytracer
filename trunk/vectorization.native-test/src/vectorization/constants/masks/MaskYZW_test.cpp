        ...
        public:
            ...
            TEST_METHOD(returnsPackedFloat8_256Mask) {
                ...
                _mm256_store_si256(
                    ...
                    _mm256_castps_si256(MaskYZW<PackedFloat8_256>())
                );
            ...
            TEST_METHOD(returnsPackedFloat4_256Mask) {
                ...
                _mm256_store_si256(
                    reinterpret_cast<PackedInts_256 *>(actual.data()),
                    _mm256_castpd_si256(MaskYZW<PackedFloat4_256>())
                );
