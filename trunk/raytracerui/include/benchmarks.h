...
ARCH_NOINLINE const bool benchmarkAABBOverlaps(const primitives::Raycast & r, const vectorization::ASizeT iterations)
{
...
ARCH_NOINLINE const vectorization::Float benchmarkAABB(const primitives::Raycast & r, const vectorization::ASizeT iterations)
{
	const primitives::AxisAlignedBoundingBox a = primitives::AxisAlignedBoundingBox(
		vectorization::Float4(-1.f, -1.f, -1.f, 1.f),
		vectorization::Float4(1.f, 1.f, 1.f, 1.f)
...
ARCH_NOINLINE const vectorization::Float benchmarkSphere(const primitives::Raycast & r, const vectorization::ASizeT iterations)
{
...
ARCH_NOINLINE const vectorization::Float benchmarkPlane(const primitives::Raycast & r, const vectorization::ASizeT iterations)
{
...
// Ray-SplittingPlane nearest intersection
ARCH_NOINLINE const vectorization::Float benchmarkMeshFacet(const primitives::Raycast & r, const vectorization::ASizeT iterations)
{
...
void benchmarks()
{
	DWORD_PTR originalAffinityMask = 0, t;
	GetProcessAffinityMask(GetCurrentProcess(), &originalAffinityMask, &t);
	...
	const Float_64 timeFactor = 4.0 * static_cast<Float_64>(iterations);
	...
	SetProcessAffinityMask(GetCurrentProcess(), originalAffinityMask);
}
