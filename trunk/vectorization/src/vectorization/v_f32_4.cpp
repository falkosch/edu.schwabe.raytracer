...
#pragma region Constant generators
    ...
    template <>
    const v_f32_4 Infinity<v_f32_4>()
    {
        return Infinity<v_f32_4::PackedType>();
    }

    template <>
    const v_f32_4 NegInfinity<v_f32_4>()
    {
...
#pragma region swizzledBlend()
    ...
    template <>
    const v_f32_4 swizzledBlend<VectorIndices::X, VectorIndices::Y, VectorIndices::Z, VectorIndices::W, true, true, true, true>(const v_f32_4 &, const v_f32_4 & b)
    {
        return b;
    }
