...
namespace vectorization
{
    ...
    const m_f32_4x4::RowVectorType SIGN_MASKR = blend<false, true, false, true>(
        Zero<m_f32_4x4::RowVectorType>(),
        NegZero<m_f32_4x4::RowVectorType>());
...
#pragma region m_f32_4x4::
    ...
    m_f32_4x4::m_f32_4x4(const m_f32_4x4::RowVectorType::PackedType & row)
        :
        row0(row),
        row1(row),
        row2(row),
    ...
    m_f32_4x4::m_f32_4x4(const m_f32_4x4::RowVectorType & row)
        :
        row0(row),
        row1(row),
        row2(row),
    ...
    m_f32_4x4::m_f32_4x4(const std::array<ValueType, SIZE> & m)
        :
    ...
    m_f32_4x4::m_f32_4x4(const m_f32_4x4::ValueType * const m)
        :
        row0(m + VectorIndices::X * COLUMNS),
        row1(m + VectorIndices::Y * COLUMNS),
        row2(m + VectorIndices::Z * COLUMNS),
    ...
    m_f32_4x4 & m_f32_4x4::operator=(const m_f32_4x4::RowVectorType::PackedType & row)
    {
        row0 = row;
        row1 = row;
        row2 = row;
    ...
    m_f32_4x4::ValueType & m_f32_4x4::operator[](const int index)
    {
    ...
    const m_f32_4x4::ValueType & m_f32_4x4::operator[](const int index) const
    {
        assert(static_cast<int>(VectorIndices::X) <= index && static_cast<ASizeT>(index) < m_f32_4x4::SIZE);
        return reinterpret_cast<const m_f32_4x4::ValueType * const>(this)[index];
    }

    m_f32_4x4::ValueType & m_f32_4x4::operator[](const ASizeT index)
    {
        assert(index < m_f32_4x4::SIZE);
        return reinterpret_cast<m_f32_4x4::ValueType * const>(this)[index];
    }

    const m_f32_4x4::ValueType & m_f32_4x4::operator[](const ASizeT index) const
    {
        assert(index < m_f32_4x4::SIZE);
        return reinterpret_cast<const m_f32_4x4::ValueType * const>(this)[index];
    }
...
#pragma region replaceColumn()
    ...
    {
        return m_f32_4x4(replaceX(m.row0, x(v)), replaceX(m.row1, y(v)),
            replaceX(m.row2, z(v)), replaceX(m.row3, w(v)));
    }

    template <>
    const m_f32_4x4 replaceColumn<VectorIndices::Y>(const m_f32_4x4 & m, const m_f32_4x4::ColumnVectorType & v)
    {
        return m_f32_4x4(replaceY(m.row0, x(v)), replaceY(m.row1, y(v)),
            replaceY(m.row2, z(v)), replaceY(m.row3, w(v)));
    }

    template <>
    const m_f32_4x4 replaceColumn<VectorIndices::Z>(const m_f32_4x4 & m, const m_f32_4x4::ColumnVectorType & v)
    {
        return m_f32_4x4(replaceZ(m.row0, x(v)), replaceZ(m.row1, y(v)),
            replaceZ(m.row2, z(v)), replaceZ(m.row3, w(v)));
    }

    template <>
    const m_f32_4x4 replaceColumn<VectorIndices::W>(const m_f32_4x4 & m, const m_f32_4x4::ColumnVectorType & v)
    {
        return m_f32_4x4(replaceW(m.row0, x(v)), replaceW(m.row1, y(v)),
            replaceW(m.row2, z(v)), replaceW(m.row3, w(v)));
    }
...
#pragma region rotate()
    ...
    const m_f32_4x4 rotate(const m_f32_4x4 & m, const m_f32_4x4::ValueType angle, const m_f32_4x4::RowVectorType & rotationAxis)
    {
...
#pragma region unproject()
    ...
    const v_f32_4 unproject(const m_f32_4x4::RowVectorType & screenPosition, const m_f32_4x4 & inverseViewProjectionMatrix, const m_f32_4x4::RowVectorType & viewport)
    {
