...
namespace vectorization
{
    ...
    const PackedFloat2_128 NegativeOne<PackedFloat2_128>() noexcept {
        return _mm_or_pd(
            One<PackedFloat2_128>(),
            NegativeZero<PackedFloat2_128>()
        );
    }
    ...
    const PackedFloat4_128 NegativeOne<PackedFloat4_128>() noexcept {
        return _mm_or_ps(
            One<PackedFloat4_128>(),
            NegativeZero<PackedFloat4_128>()
        );
    }
    ...
    const PackedFloat4_256 NegativeOne<PackedFloat4_256>() noexcept {
        return _mm256_or_pd(
            One<PackedFloat4_256>(),
            NegativeZero<PackedFloat4_256>()
        );
    }
    ...
    const PackedFloat8_256 NegativeOne<PackedFloat8_256>() noexcept {
        return _mm256_or_ps(
            One<PackedFloat8_256>(),
            NegativeZero<PackedFloat8_256>()
        );
    }
}