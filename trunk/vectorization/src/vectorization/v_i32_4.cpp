...
#pragma region v_i32_4::
	...
	v_i32_4::v_i32_4(const v_i32_4::PackedType & v)
		:
		components(v)
	{ }

	v_i32_4::v_i32_4(const v_i32_4::ValueType s)
		:
		components(_mm_set1_epi32(s))
	{ }

	v_i32_4::v_i32_4(const v_i32_4::ValueType x, const v_i32_4::ValueType y)
		:
		components(_mm_set_epi32(Zero<v_i32_4::ValueType>(), Zero<v_i32_4::ValueType>(), y, x))
	{ }

	v_i32_4::v_i32_4(const v_i32_4::ValueType x, const v_i32_4::ValueType y, const v_i32_4::ValueType z)
		:
		components(_mm_set_epi32(Zero<ValueType>(), z, y, x))
	{ }

	v_i32_4::v_i32_4(const v_i32_4::ValueType x, const v_i32_4::ValueType y, const v_i32_4::ValueType z, const v_i32_4::ValueType w)
		:
		components(_mm_set_epi32(w, z, y, x))
	{ }

	v_i32_4 & v_i32_4::operator=(const v_i32_4::PackedType & v)
	{
		components = v;
		return *this;
	}
	...
	void v_i32_4::setX(const v_i32_4::ValueType v)
	{
		components = _mm_insert_epi32(components, v, VectorIndices::X);
	}

	void v_i32_4::setY(const v_i32_4::ValueType v)
	{
		components = _mm_insert_epi32(components, v, VectorIndices::Y);
	}

	void v_i32_4::setZ(const v_i32_4::ValueType v)
	{
		components = _mm_insert_epi32(components, v, VectorIndices::Z);
	}

	void v_i32_4::setW(const v_i32_4::ValueType v)
	{
