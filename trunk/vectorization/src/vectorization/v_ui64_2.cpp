...
#pragma region Constant generators
    ...
    {
        return _mm_srli_epi64(MaskAll<v_ui64_2::PackedType>(), sizeof(v_ui64_2::ValueType) * CHAR_BIT - 1);
    }

    template <>
    const v_ui64_2 Two<v_ui64_2>()
    {
        return _mm_slli_epi64(_mm_srli_epi32(MaskAll<v_ui64_2::PackedType>(), sizeof(v_ui64_2::ValueType) * CHAR_BIT - 1), 1);
    }
...
#pragma region blend()
    ...
    template <>
    const v_ui64_2 blend<false, false>(const v_ui64_2 & a, const v_ui64_2 &)
    {
        return a;
    }
    ...
    template <>
    const v_ui64_2 blend<true, true>(const v_ui64_2 &, const v_ui64_2 & b)
    {
        return b;
    }
