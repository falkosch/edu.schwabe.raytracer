...
#pragma region Mask...()
	...
	template const long MaskAll<long>() noexcept;
	template const unsigned long MaskAll<unsigned long>() noexcept;
	template const Int_8 MaskAll<Int_8>() noexcept;
	template const UInt_8 MaskAll<UInt_8>() noexcept;
	template const Int_16 MaskAll<Int_16>() noexcept;
	template const UInt_16 MaskAll<UInt_16>() noexcept;
	template const Int_32 MaskAll<Int_32>() noexcept;
	template const UInt_32 MaskAll<UInt_32>() noexcept;
	template const Int_64 MaskAll<Int_64>() noexcept;
	template const UInt_64 MaskAll<UInt_64>() noexcept;
...
#pragma region OneY
	...
	template <>
	const PackedFloat4_128 OneY<PackedFloat4_128>() noexcept
	{
		return _mm_castsi128_ps(
			_mm_slli_si128(
				_mm_srli_si128(
	...
	template <>
	const PackedFloat2_128 OneY<PackedFloat2_128>() noexcept
	{
		return _mm_castsi128_pd(
			_mm_slli_si128(
				_mm_castpd_si128(One<PackedFloat2_128>()),
...
#pragma region NegZero
	...
	template <>
	const PackedFloat4_128 NegZero<PackedFloat4_128>() noexcept
	{
		return _mm_castsi128_ps(
			_mm_slli_epi32(
	...
	template <>
	const Float_32 NegZero<Float_32>() noexcept
	{
		return _mm_cvtss_f32(NegZero<PackedFloat4_128>());
	}

	template <>
	const Float_64 NegZero<Float_64>() noexcept
	{
...
#pragma region NegOne
	...
	template const Int_8 NegOne<Int_8>() noexcept;
	template const Int_16 NegOne<Int_16>() noexcept;
	template const Int_32 NegOne<Int_32>() noexcept;
	template const Int_64 NegOne<Int_64>() noexcept;

	template <>
	const PackedFloat4_128 NegOne<PackedFloat4_128>() noexcept
	{
		return _mm_or_ps(One<PackedFloat4_128>(), NegZero<PackedFloat4_128>());
	}

	template <>
	const PackedFloat2_128 NegOne<PackedFloat2_128>() noexcept
	{
		return _mm_or_pd(One<PackedFloat2_128>(), NegZero<PackedFloat2_128>());
	}

	template <>
	const Float_32 NegOne<Float_32>() noexcept
	{
		return _mm_cvtss_f32(NegOne<PackedFloat4_128>());
	}

	template <>
	const Float_64 NegOne<Float_64>() noexcept
	{
...
#pragma region NegTwo
	...
	template const Int_8 NegTwo<Int_8>() noexcept;
	template const Int_16 NegTwo<Int_16>() noexcept;
	template const Int_32 NegTwo<Int_32>() noexcept;
	template const Int_64 NegTwo<Int_64>() noexcept;

	template <>
	const PackedFloat4_128 NegTwo<PackedFloat4_128>() noexcept
	{
	...
	template <>
	const PackedFloat2_128 NegTwo<PackedFloat2_128>() noexcept
	{
	...
	template <>
	const Float_32 NegTwo<Float_32>() noexcept
	{
		return _mm_cvtss_f32(NegTwo<PackedFloat4_128>());
	}

	template <>
	const Float_64 NegTwo<Float_64>() noexcept
	{
...
#pragma region NegInfinity
	...
	template <>
	const PackedFloat4_128 NegInfinity<PackedFloat4_128>() noexcept
	{
	...
	template <>
	const PackedFloat2_128 NegInfinity<PackedFloat2_128>() noexcept
	{
	...
	template <>
	const Float_32 NegInfinity<Float_32>() noexcept
	{
		return _mm_cvtss_f32(NegInfinity<PackedFloat4_128>());
	}

	template <>
	const Float_64 NegInfinity<Float_64>() noexcept
	{
