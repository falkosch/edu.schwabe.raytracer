...
#pragma region v_ui32_4::
    ...
    v_ui32_4::v_ui32_4(const PackedType & v)
        :
        components(v)
    { }

    v_ui32_4::v_ui32_4(const ValueType s)
        :
        components(_mm_set1_epi32(static_cast<int>(s)))
    { }

    v_ui32_4::v_ui32_4(const ValueType x, const ValueType y)
        :
        components(_mm_set_epi32(Zero<int>(), Zero<int>(), static_cast<int>(y), static_cast<int>(x)))
    { }

    v_ui32_4::v_ui32_4(const ValueType x, const ValueType y, const ValueType z)
        :
        components(_mm_set_epi32(Zero<int>(), static_cast<int>(z), static_cast<int>(y), static_cast<int>(x)))
    { }

    v_ui32_4::v_ui32_4(const ValueType x, const ValueType y, const ValueType z, const ValueType w)
        :
        components(_mm_set_epi32(static_cast<int>(w), static_cast<int>(z), static_cast<int>(y), static_cast<int>(x)))
    { }

    v_ui32_4 & v_ui32_4::operator=(const PackedType & v)
    {
        components = v;
        return *this;
    }
