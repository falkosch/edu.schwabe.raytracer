...
namespace vectorization
{
    ...
    struct v_ui32_4
    {
        ...
        v_ui32_4(const PackedType & v);

        explicit v_ui32_4(const ValueType s);

        explicit v_ui32_4(const ValueType x, const ValueType y);

        explicit v_ui32_4(const ValueType x, const ValueType y, const ValueType z);

        explicit v_ui32_4(const ValueType x, const ValueType y, const ValueType z, const ValueType w);
        ...
        v_ui32_4 & operator=(const PackedType & v);
...
#pragma region swizzle()
    ...
    // generic swizzle
    inline const v_ui32_4 swizzle(const v_ui32_4 & v)
    {
...
#pragma region blend()
    ...
    inline const v_ui32_4 blend(const v_ui32_4 & a, const v_ui32_4 & b)
    {
...
#pragma region swizzledBlend()
    ...
    inline const v_ui32_4 swizzledBlend(const v_ui32_4 & a, const v_ui32_4 & b)
    {
    ...
    inline const v_ui32_4 swizzledBlend_2x2(const v_ui32_4 & a, const v_ui32_4 & b)
    {
...
#pragma region swizzledBlendMasked()
    ...
    template <ASizeT X, ASizeT Y, ASizeT Z, ASizeT W>
    inline const v_ui32_4 swizzledBlendMasked(const v_ui32_4 & a, const v_ui32_4 & b, const v_ui32_4 & mask)
    {
...
#pragma region setComponent()
    ...
    void setComponent(v_ui32_4 & v, const v_ui32_4::ValueType s);
...
#pragma region replaceComponent()
    ...
    template <ASizeT Index>
    const v_ui32_4 replaceComponent(const v_ui32_4 & v, const v_ui32_4::ValueType s);
...
#pragma region component()
    ...
    template <ASizeT Index>
    const v_ui32_4::ValueType component(const v_ui32_4 & v);
